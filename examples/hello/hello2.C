  ...
  : WApplication(env)
{
  ...
  WContainerWidget *root_ = groupBox;//root();
  ...
  WGroupBox *rgb = new WGroupBox("Root");
  WVBoxLayout *vLayout = new WVBoxLayout();
//  root()->addWidget(rgb);
  root()->setLayout(vLayout);
  vLayout->addWidget(new WGroupBox("Hello World!"));
  vLayout->addWidget(groupBox,1);
  vLayout->addWidget(new WGroupBox("Bottom box"));
  /*
